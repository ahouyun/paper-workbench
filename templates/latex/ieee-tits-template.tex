...
Table~\ref{tab:main} shows the comparison results on METR-LA and PEMS-BAY datasets.
Our method achieves the best performance across all metrics and prediction horizons.

\begin{table*}[!t]
\centering
\caption{Performance comparison on METR-LA and PEMS-BAY datasets.
The best results are in \textbf{bold} and the second best are \underline{underlined}.
↓ indicates lower is better.}
\label{tab:main}
\begin{tabular}{l|ccc|ccc}
\toprule
\multirow{2}{*}{Method} & \multicolumn{3}{c|}{METR-LA} & \multicolumn{3}{c}{PEMS-BAY} \\
\cmidrule{2-7}
& MAE↓ 15min & MAE↓ 30min & MAE↓ 60min & MAE↓ 15min & MAE↓ 30min & MAE↓ 60min \\
\midrule
DCRNN & 3.17 & 3.60 & 4.16 & 1.74 & 2.07 & 2.44 \\
STGCN & 3.47 & 4.03 & 4.54 & 1.69 & 2.03 & 2.40 \\
GWNet & 2.69 & 3.07 & 3.53 & 1.58 & 1.84 & 2.17 \\
STAEformer & 2.49 & 2.78 & 3.15 & 1.48 & 1.65 & 1.88 \\
PDFormer & 2.60 & 2.83 & 3.09 & 1.38 & 1.61 & 1.88 \\
\midrule
\textbf{Ours} & \textbf{2.38} & \textbf{2.65} & \textbf{2.98} & \textbf{1.32} & \textbf{1.52} & \textbf{1.75} \\
\bottomrule
\end{tabular}
\end{table*}
...
\begin{table}[!t]
\centering
\caption{Ablation study on METR-LA (60min).
...
\midrule
Full Model & \textbf{2.98} & \textbf{5.85} & \textbf{7.52\%} \\
