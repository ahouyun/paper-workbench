...
| 能力 | 说明 | 限制 |
|------|------|------|
| 📝 **论文撰写参考** | 摘要/引言/方法/实验/结论的写作模式和技巧 | 需要用户提供核心内容 |
| 📊 **图表制作参考** | 3300行图表规范 + Python模板 + LaTeX表格 | 需要用户运行代码 |
| 🧪 **实验设计参考** | 4种消融类型、效率对比、鲁棒性评估 | 需要用户自己跑实验 |
| ✍️ **论文润色参考** | 51条润色规则 + 去AI味 + 逻辑严谨性检查 | 需要用户自己修改 |
| 💡 **创新灵感参考** | 39个创新方向，覆盖GNN/Transformer/Mamba/Diffusion/LLM等 | 需要用户自己验证 |
| 📐 **逻辑严谨参考** | Claim-Evidence-Boundary三要素，六段式漏斗结构 | 需要用户自己应用 |
| 📄 **LaTeX模板** | IEEE官方模板 + 自定义TITS模板 | 示例数据需替换 |
| 📋 **投稿指南** | Cover Letter + 审稿回复 + 拒稿处理 | 参考性质 |
...
| 来源 | 时间范围 | 说明 |
|------|---------|------|
| IEEE TITS/TKDE/TNNLS/TVT/TIV | 2024-2026 | 110+篇期刊论文 |
| KDD/AAAI/NeurIPS/ICLR/ICML | 2024-2026 | 204篇顶会论文 |
| WWW/CIKM/IJCAI/SIGIR | 2024-2026 | 60+篇会议论文 |
| Transportation Research | 2024-2026 | 20+篇交通期刊 |
| Nature/Scientific Reports | 2024-2026 | 15+篇高影响力期刊 |
| arXiv预印本 | 2025-2026 | 150+篇最新预印本 |
| 综述论文参考文献 | 综合 | 16篇综述，2500+篇参考文献 |
| 顶级研究组论文 | 2024-2026 | 10个研究组，55篇论文 |
