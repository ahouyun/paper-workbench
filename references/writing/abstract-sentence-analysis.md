...
## 补充论文（CrossRef 2025 - GNN)

| 论文 | DOI | 核心创新 |
|------|-----|---------|
| River Discharge GNN | 10.5194/egusphere-egu26-8946 | 时空图神经网络河流流量预测 |

## 补充论文（CrossRef 2025 - Transformer)

| 论文 | DOI | 核心创新 |
|------|-----|---------|
| FCA-Transformer | 10.22541/au.173772018.80603459/v1 | 特征金字塔时间序列预测 |
...
| 论文 | DOI | 核心创新 |
|------|-----|---------|
| RL Firewall | 10.22541/au.174949149.94911054/v1 | 强化学习动态Web防火墙 |
| RL Firewall Auto | 10.55640/ijiot-05-01-10 | 强化学习自动生成防火墙策略 |
| RL Robotics | 10.36227/techrxiv.176116523.30415088/v1 | 强化学习机器人分拣策略空间 |
...
|------|-----|---------|
| WR-MDGCN | 10.2139/ssrn.6293369 | 小波残差多尺度动态图卷积交通流预测 |
| DGSTAN | 10.1088/1361-6501/add955 | 深度图卷积时空注意力学习模型 |
...
## 补充论文（CrossRef 2025 - 医学图像)

| 论文 | DOI | 核心创新 |
|------|-----|---------|
| DL Medical Segmentation | 10.20944/preprints202505.2151.v1 | 深度学习医学图像分割分类综述 |

## 补充论文（CrossRef 2025 - NLP)
